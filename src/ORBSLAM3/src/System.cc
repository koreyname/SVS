    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    cout << "Modify By Korey (2026-01-05)" << endl;
...
void System::SaveTrajectoryTUM(const string &filename)
{
    ...
    if(vpKFs.empty())
    {
        cerr << "WARNING: SaveTrajectoryTUM: no keyframes in atlas, trajectory will not be saved." << endl;
        return;
    }
...
void System::SaveTrajectoryEuRoC(const string &filename)
{
    ...
    {
        cerr << "WARNING: SaveTrajectoryEuRoC: no keyframes in atlas, trajectory will not be saved." << endl;
        return;
    }
    ...
    if(vpKFs.empty())
    {
        cerr << "WARNING: SaveTrajectoryEuRoC: no keyframes in selected map, trajectory will not be saved." << endl;
        return;
    }
...
void System::SaveTrajectoryEuRoC(const string &filename, Map* pMap)
{
    ...
    if(vpKFs.empty())
    {
        cerr << "WARNING: SaveTrajectoryEuRoC: no keyframes in map, trajectory will not be saved." << endl;
        return;
    }
...
void System::SaveTrajectoryKITTI(const string &filename)
{
    ...
    if(vpKFs.empty())
    {
        cerr << "WARNING: SaveTrajectoryKITTI: no keyframes in atlas, trajectory will not be saved." << endl;
        return;
    }
...
bool System::GetRiskImage(cv::Mat &out)
{
    if(!mpTracker)
        return false;
    return mpTracker->GetRiskImage(out);
}

bool System::GetRiskMaskImage(cv::Mat &out)
{
    if(!mpTracker)
        return false;
    return mpTracker->GetRiskMaskImage(out);
}
