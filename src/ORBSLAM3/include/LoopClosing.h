...
protected:
    ...
    void CorrectLoop();
    void SaveLoopMatchImage();
    bool EvaluateLoopSafety(float &safeRatio, double &klDiv, float &cover);
    void UpdateLoopSwitch(bool bSuccess, float safeRatio);
    ...
    bool mbLoopDetected;
    float mLoopSwitchState = 1.f;
    bool mbLoopEnabled = true;
