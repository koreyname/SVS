...
{
    ros::init(argc, argv, "MonoAR", ros::init_options::NoSigintHandler);
    ros::start();
    ...
    while(ros::ok() && !ORB_SLAM3::utils::ShouldQuit())
...
void ImageGrabber::GrabImage(const sensor_msgs::ImageConstPtr& msg)
{
    ...
    cv::Mat imu;
    Sophus::SE3f TcwSE3 = mpSLAM->TrackMonocular(cv_ptr->image,cv_ptr->header.stamp.toSec());
    cv::Mat Tcw = ORB_SLAM3::Converter::toCvMat(TcwSE3.matrix());
